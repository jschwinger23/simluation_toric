...
def main():
    for iter1 in range(2):  # This loop is over the dimension of the code
        ...
        for iter2 in range(
                2):  # This loop is over the standard deviation sigma of the shift errors
            start_time = time.time()
            logical_error1 = 0    # This variable is used to count the number of wrong error correction
            logical_error2 = 0
            sum = 100
            dim = 4 + iter1*4           # The dimension of the code
